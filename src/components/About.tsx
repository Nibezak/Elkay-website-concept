    ...
    <section className={"w-full bg-white flex flex-col items-center py-32 px-6 md:px-12 min-h-screen " + (className || "")}>
      <motion.div className="w-full max-w-[1000px] flex flex-col gap-16" initial="initial" animate="animate" variants={containerVariants}>
        ...
        <div className="flex flex-col gap-6 items-center text-center">
          <motion.h1 variants={itemVariants} className="text-[#093600] text-4xl md:text-6xl font-bold font-serif leading-tight">
            Our Heritage in <br/> Every Loaf
          </motion.h1>
          <motion.p variants={itemVariants} className="text-[#093600]/80 text-lg md:text-xl font-sans max-w-[700px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8">
          <motion.div variants={itemVariants} className="flex flex-col gap-4">
            <h2 className="text-3xl font-serif text-[#093600] font-bold">The Science of Baking</h2>
            <p className="text-[#093600]/80 font-sans leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-4">
            <h2 className="text-3xl font-serif text-[#093600] font-bold">Uncompromising Quality</h2>
            <p className="text-[#093600]/80 font-sans leading-relaxed">
